...
def main(argv):
    ...
    if project is not None:
        ...
        print 'Programming language summary for project: {0}'.format(project)
        useView = True
    ...
    nulljobs, nullkau = xq.getNullLinkerUse(xaltC, xaltRunT)
    print '\nLink event not identified:\n\tJobs = {:d}\n\t kAU = {:.3f}'.format(nulljobs, nullkau)

    # Print total linker event statistics
    xq.printTotalLinkerStats(xaltC, xaltRunT)
